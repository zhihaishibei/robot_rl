...
class ActorNet:
    ...
    def train_actor(self,x,x_,y,is_training=True):
        _,loss,learning_rate,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_=\
        self.sess.run([self.train_step,self.loss,self.learning_rate,self.conv1_bn.train_mean,self.conv1_bn.train_var,self.conv2_bn.train_mean,self.conv2_bn.train_var,\
